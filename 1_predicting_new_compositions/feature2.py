...
def construct_feature(X,calnum,features, training):
    ...
    mendeleev  = pd.read_csv('mendeleev.csv', index_col=0)
    datalen = X.shape[0]
    info=len(features)+3 -8    #basic information #ordering subtract
    numspieces = 6   # Sn, Se. Na, dopant
    nFeat=numspieces+info+1
    
    pristine=[0.5329, 5.3731, -0.1301, 5.9059, 0.0890,5.3403,5.2493,6.0760,6.1073,-0.1373,-0.2572,31.5707,0.1090]    #concentration, Band gap, VBM1_E, VBM1_M,CBM1_E,CBM1_M
    ...
    for i in range(0,nTrain):
        X_train[i,2] = X_train[i,1]**1.5
        X_train[i,3] = 1/X_train[i,1]
    ...
    for kk in features:
        ...
        if kk == 'bandgap_sn':
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['ion'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['ion'])
            temp3 = mendeleev.iloc[50]['ion']
            temp4 = mendeleev.iloc[34]['ion']
            
            sn=[]
            se=[]
            for jjjj in range(datalen):
                sn.append(temp3)
                se.append(temp4)

                
            X_train[:,n] = temp1*dopant1_ratio + temp2*dopant2_ratio +\
                           sn*X_train[:,1+info] + se*X_train[:,2+info]
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['covalent'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['covalent'])
            temp3 = mendeleev.iloc[50]['covalent']
            temp4 = mendeleev.iloc[34]['covalent']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['vdw'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['vdw'])
            temp3 = mendeleev.iloc[50]['vdw']
            temp4 = mendeleev.iloc[34]['vdw']
            ...
            for jjjj in range(datalen):
                ...
                se.append(temp4)  
            one = np.ones(nTrain)
            X_train[:,n] = temp1*one + temp2*one+ sn*one + se*one
            n+=1
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['atomic_radius'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['atomic_radius'])
            temp3 = mendeleev.iloc[50]['atomic_radius']
            temp4 = mendeleev.iloc[34]['atomic_radius']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['pauling_en'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['pauling_en'])
            temp3 = mendeleev.iloc[50]['pauling_en']
            temp4 = mendeleev.iloc[34]['pauling_en']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['en_allen'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['en_allen'])
            temp3 = mendeleev.iloc[50]['en_allen']
            temp4 = mendeleev.iloc[34]['en_allen']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['polarizability'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['polarizability'])
            temp3 = mendeleev.iloc[50]['polarizability']
            temp4 = mendeleev.iloc[34]['polarizability']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['melting_point'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['melting_point'])
            temp3 = mendeleev.iloc[50]['melting_point']
            temp4 = mendeleev.iloc[34]['melting_point']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['boiling_point'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['boiling_point'])
            temp3 = mendeleev.iloc[50]['boiling_point']
            temp4 = mendeleev.iloc[34]['boiling_point']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['thermal_conductivity'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['thermal_conductivity'])
            temp3 = mendeleev.iloc[50]['thermal_conductivity']
            temp4 = mendeleev.iloc[34]['thermal_conductivity']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['specific_heat'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['specific_heat'])
            temp3 = mendeleev.iloc[50]['specific_heat']
            temp4 = mendeleev.iloc[34]['specific_heat']
            ...
            temp1 = np.array(mendeleev.iloc[dopant1.astype(int)]['density'])
            temp2 = np.array(mendeleev.iloc[dopant2.astype(int)]['density'])
            temp3 = mendeleev.iloc[50]['density']
            temp4 = mendeleev.iloc[34]['density']
